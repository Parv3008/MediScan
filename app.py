...
diabetes_model = pickle.load(open('data.sav','rb'))
...
# parkinsons_model = pickle.load(open("B:\minor dataset\multiple-disease-prediction-streamlit-app-main\multiple-disease-prediction-streamlit-app-main\saved_models\parkinsons_model.sav","rb"))
